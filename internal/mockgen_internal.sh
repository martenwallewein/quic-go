...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/martenwallewein/quic-go/
...
rsync -a $GOPATH/src/github.com/martenwallewein/quic-go/* $TEMP_DIR/src/github.com/martenwallewein/quic-go/ --exclude example
mv $TEMP_DIR/src/github.com/martenwallewein/quic-go/internal $TEMP_DIR/src/github.com/martenwallewein/quic-go/internalpackage
